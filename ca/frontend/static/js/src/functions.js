...
var functions=(function(config){
    ...
    return {
        ...
        ajaxReturnErrorHandler:function(errorCode){
            ...
            switch(errorCode){
                case "30002":
                    message=config.messages.sendMsgTooMany;
                    break;
                case "30003":
                    message=config.messages.telNotExist;
                    break;
                case "30004":
                    message=config.messages.validCodeExpire;
                    break;
                case "30005":
                    message=config.messages.validCodeNotRight;
                    break;
                case "30006":
                    message=config.messages.imgCodeNotRight;
                    break;
                default :
